...
<meta name="keywords" content="the sparks foundation internship certificate, donation,the sparks foundation internship, grip at the sparks foundation, grip at the sparks foundation internship, the sparks foundation grip, the sparks foundation internship web development, the sparks foundation internship, the sparks foundation linkedin, the sparks foundation network,the sparks foundation web development internship, tsf, tsf at grip, grip, tsf grip,Graduate Rotational Internship Program.">
<meta name="author" content="Saraswathi Yendu">
...
$sql = $conn -> query("select * from cust ");
?>
           ...
           echo" <h2><b>".$row["name"]."</b></h2>";
            ...
            echo "<div class='details-customer-".$row["id"]."' id='details-customer-".$row["id"]."'>";
                echo "<div class='details-customer-".$row["id"]."-content'>";
                    ...
                    echo    "<p>phone_number:- <span>".$row["phone_number"]."</span></p>";
                    echo     "<p>balance:- <span id='".$row["name"]."'><i class='fa fa-inr'> ".$row["balance"]." </i></span></p>";
      ...
      <div class="footer-right">
          <p class="footer-company-about">
            <span>About the organization</span>
              It's a leading private bank sector and Indian financial Institution which its wholly-owned subsidiary.
			  This Organization offers a wide range of banking products and financial services to corporate and retail customers through a variety of delivery channels and through its group companies.This include eminent individuals with a wealth of experience in international business, management consulting, banking and financial services.
          </p>
      </div>
    </footer>
  
    <div class="footer-bottom">
        <p class="footer-content">Designed & Developed by @Saraswathi Yendu</p>
    </div>
</section>
</body>
</html> 
